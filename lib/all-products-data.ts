...
export const offlineProducts: ProductProps[] = [
    {
    id: 1,
    title: "Monochrome Mountain Themed T-Shirt",
    price: 44,
   ...
   "https://i.imgur.com/R2PN9Wq.jpeg",    
    ...
    {
    id: 7,
    title: "Comfort Drawstring Joggers",
    price: 79,
    ...
    {
    id: 14,
    title: "High-Waisted Athletic Shorts",
    price: 43,
    ...
    {
    id: 16,
    title: "White Tee - Timeless Style and Comfort",
    price: 73,
